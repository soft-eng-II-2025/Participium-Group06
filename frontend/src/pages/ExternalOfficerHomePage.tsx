...
const TechAgentHomePage: React.FC = () => {
  ...
  // TODO get reports assigned to the ext officer, mock for now
  const reports : ReportResponseDTO[] = [
    ...
    //   latitude: 56.78,
    //   user: {
    //     username: "User One", email: "user1@example.com",
    //     first_name: "",
    //     last_name: ""
    //   },
    //   category: "General",
    ...
    //   longitude: 21.43,
    //   latitude: 65.87,
    //   user: { username: "User Two", email: "user2@example.com", first_name: "", last_name: "" },
    ...
    //   longitude: 98.76,
    //   latitude: 54.32,
    //   user: { username: "User Three", email: "user3@example.com", first_name: "", last_name: "" },
