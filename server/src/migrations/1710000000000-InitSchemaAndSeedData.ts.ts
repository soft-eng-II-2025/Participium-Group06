...
export class InitSchemaAndSeedData1710000000000 implements MigrationInterface {
  ...
  (1,7.6869,45.0703,'Sewer Blockage in City Center','Sewer drain blocked in the city center.','In Progress','',10,1,3,null),
  (2,7.6780,45.0710,'Damaged Bench in Piazza Statuto','Broken bench in Piazza Statuto.','Pending Approval','',null,2,8,null),
  (3,7.6820,45.0740,'Non-Working Streetlight on Via Garibaldi','Streetlight not working on Via Garibaldi.','Assigned','',null,4,4,null),
  (4,7.6905,45.0665,'Faulty Public Lighting in San Salvario','Faulty public lighting in the San Salvario area.','In Progress','',12,4,4,null),
  (5,7.7000,45.0675,'Broken Traffic Light on Corso Vittorio','Broken traffic light at the Corso Vittorio intersection.','Pending Approval','',null,5,6,null),
  (6,7.7020,45.0730,'Broken Fire Hydrant in Vanchiglia','Fire hydrant broken in the Vanchiglia area.','Assigned','',null,6,1,null),
  (7,7.6815,45.0650,'Uneven Pavement on Crocetta Sidewalk','Uneven pavement on the sidewalk in Crocetta.','In Progress','',4,7,7,null),
  (8,7.6880,45.0750,'Damaged Pedestrian Crossing Sign','Damaged pedestrian crossing sign.','Pending Approval','',null,7,6,null),
  (9,7.6750,45.0680,'Broken Slide in Mirafiori Nord Playground','Slide in the playground damaged in Mirafiori Nord.','Assigned','',null,10,8,null),
  (10,7.6920,45.0690,'Damaged Road Barrier in Borgo Po','Road barrier damaged in Borgo Po.','In Progress','',4,10,7,null),
  (11,7.6840,45.0725,'Illegible Road Sign in Dora Riparia','Road sign unreadable in Dora Riparia.','Assigned','',null,1,6,null),
  (12,7.6800,45.0770,'Debris on the Roadway in Cit Turin','Debris on the roadway in Cit Turin.','Pending Approval','',null,2,7,null),
  (13,7.6990,45.0720,'Fallen Road Sign in Aurora','Road sign fallen in Aurora.','In Progress','',6,3,6,null),
  (18,7.6980,45.0660,'Overflowing Street Bin in Santa Rita','Street bin overflowing in Santa Rita.','In Progress','',10,8,5,null),
  (19,7.6830,45.0698,'Broken Swing in Pozzo Strada Playground','Swing broken in the playground in Pozzo Strada.','Assigned','',8,9,8,null),
  (20,7.6890,45.0715,'Poor Road Conditions in Barriera di Milano','Poor road conditions in Barriera di Milano.','In Progress','',4,10,7,null),
  (21,7.6910,45.0760,'Large Pothole on Road in Rebaudengo','Large pothole on the road in Rebaudengo.','Pending Approval','',null,1,7,null),
  (22,7.6775,45.0708,'Flooded Street After Rain in Parella','Street flooded after heavy rain in Parella.','In Progress','',10,2,3,null),
  (23,7.6955,45.0685,'Lighting Outage in Crocetta','Several streetlights out in Crocetta.','Assigned','',12,3,4,null),
  (14,7.6765,45.0735,'Fallen Tree Branch in Valentino Park','A tree branch has fallen in Valentino Park.','Assigned','',8,4,8,null),
  (15,7.6875,45.0670,'Flooding Due to Clogged Sewer in Porta Nuova','Flooding caused by a clogged sewer in Porta Nuova.','In Progress','',10,5,3,null),
  (16,7.6935,45.0745,'Graffiti on Public Wall in Vanchiglietta','Graffiti on a public wall in Vanchiglietta.','Pending Approval','',null,6,9,null),
  ...
  (24,7.7060,45.0718,'Trash Scattered in Public Area in Cavoretto','Trash scattered in a public area in Cavoretto.','In Progress','',10,4,5,null),
  (25,7.6855,45.0738,'Water Leak on Roadway in Lingotto','Water leaking onto the roadway in Lingotto.','Resolved','',4,5,1,null)
`);
