...
export class InitSchemaAndSeedData1710000000000 implements MigrationInterface {
    ...
    await queryRunner.query(`
      ...
      VALUES
        ...
        (3,'annaverdi','annaverdi@gmail.com',
         ...
         'Anna','Verdi',NULL,NULL,true, true),
        ...
        (5,'paolorussi','paolorussi@gmail.com',
         ...
         'Paolo','Russi',NULL,NULL,true, true),
        ...
        (8,'francescacosta','francescacosta@gmail.com',
         ...
         'Francesca','Costa',NULL,NULL,true, true),
  ...
  (1,7.6869,45.0703,'Sewer Blockage in City Center','Sewer drain blocked in the city center.','In Progress','',9,1,3,null,false),
  (2,7.6780,45.0710,'Damaged Bench in Piazza Statuto','Broken bench in Piazza Statuto.','Pending Approval','',7,2,8,null,false),
  (3,7.6820,45.0740,'Non-Working Streetlight on Via Garibaldi','Streetlight not working on Via Garibaldi.','Assigned','',null,3,4,null,false),
  (4,7.6905,45.0665,'Faulty Public Lighting in San Salvario','Faulty public lighting in the San Salvario area.','In Progress','',11,4,4,null,false),
  (5,7.7000,45.0675,'Broken Traffic Light on Corso Vittorio','Broken traffic light at the Corso Vittorio intersection.','Pending Approval','',5,5,6,null,false),
  ...
  (7,7.6815,45.0650,'Uneven Pavement on Crocetta Sidewalk','Uneven pavement on the sidewalk in Crocetta.','In Progress','',3,7,7,null,false),
  (8,7.6880,45.0750,'Damaged Pedestrian Crossing Sign','Damaged pedestrian crossing sign.','Pending Approval','',5,7,6,null,false),
  (9,7.6750,45.0680,'Broken Slide in Mirafiori Nord Playground','Slide in the playground damaged in Mirafiori Nord.','Assigned','',null,9,8,null,false),
  (10,7.6920,45.0690,'Damaged Road Barrier in Borgo Po','Road barrier damaged in Borgo Po.','In Progress','',3,10,7,null,false),
  (11,7.6840,45.0725,'Illegible Road Sign in Dora Riparia','Road sign unreadable in Dora Riparia.','Assigned','',null,1,6,null,false),
  (12,7.6800,45.0770,'Debris on the Roadway in Cit Turin','Debris on the roadway in Cit Turin.','Pending Approval','',4,2,7,null,false),
  (13,7.6990,45.0720,'Fallen Road Sign in Aurora','Road sign fallen in Aurora.','In Progress','',5,3,6,null,false),
  (18,7.6980,45.0660,'Overflowing Street Bin in Santa Rita','Street bin overflowing in Santa Rita.','In Progress','',9,8,5,null,false),
  (19,7.6830,45.0698,'Broken Swing in Pozzo Strada Playground','Swing broken in the playground in Pozzo Strada.','Assigned','',7,9,8,null,false),
  (20,7.6890,45.0715,'Poor Road Conditions in Barriera di Milano','Poor road conditions in Barriera di Milano.','In Progress','',3,10,7,null,false),
  (21,7.6910,45.0760,'Large Pothole on Road in Rebaudengo','Large pothole on the road in Rebaudengo.','Pending Approval','',3,1,7,null,false),
  (22,7.6775,45.0708,'Flooded Street After Rain in Parella','Street flooded after heavy rain in Parella.','In Progress','',9,2,3,null,false),
  (23,7.6955,45.0685,'Lighting Outage in Crocetta','Several streetlights out in Crocetta.','Assigned','',11,3,4,null,false),
  (14,7.6765,45.0735,'Fallen Tree Branch in Valentino Park','A tree branch has fallen in Valentino Park.','Assigned','',7,4,8,null,false),
  (15,7.6875,45.0670,'Flooding Due to Clogged Sewer in Porta Nuova','Flooding caused by a clogged sewer in Porta Nuova.','In Progress','',9,5,3,null,false),
  (16,7.6935,45.0745,'Graffiti on Public Wall in Vanchiglietta','Graffiti on a public wall in Vanchiglietta.','Pending Approval','',13,6,9,null,false),
  ...
  (24,7.7060,45.0718,'Trash Scattered in Public Area in Cavoretto','Trash scattered in a public area in Cavoretto.','In Progress','',9,4,5,null,false),
  (25,7.6855,45.0738,'Water Leak on Roadway in Lingotto','Water leaking onto the roadway in Lingotto.','Resolved','',3,5,1,null,false)
`);
