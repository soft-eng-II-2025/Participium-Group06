...
async function createReportWizard(
    ...
    const TORINO_BOUNDARY = [
        [7.7011, 45.1504], [7.7348, 45.1325], [7.7565, 45.1051],
        [7.7282, 45.0681], [7.7015, 45.0450], [7.6749, 45.0118],
        [7.6416, 44.9972], [7.6152, 45.0145], [7.5878, 45.0298],
        [7.5826, 45.0611], [7.5511, 45.0674], [7.5682, 45.0933],
        [7.6046, 45.1157], [7.6256, 45.1402], [7.6599, 45.1585],
        [7.7011, 45.1504]
    ];
